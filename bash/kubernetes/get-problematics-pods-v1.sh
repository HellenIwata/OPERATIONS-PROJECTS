...
# Faz uma única chamada para obter todos os pods problemáticos e formata a saída para JSON com jq
# Isso é mais eficiente do que iterar sobre cada namespace.
